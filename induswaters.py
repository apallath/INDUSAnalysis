"""
Analyse output files produced by GROMACS 4.5.3 with indirect umbrella sampling,
write data to output files, and generate plots.
Call from command line, provide command line args.
